...
$acl['member']['failRoute'] = array(
        ...
        <p class="normal">You have to assign the rules to TeaAcl in bootstrap.</p>
		<pre>
Tea::acl()->rules = $acl;
...
class SnsController extends TeaController{
