...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
	  ...
	  <div class="content">
		...
		<p class="normal">Here you can test and learn about the handling of URI routes in Tea framework.</p>
...
<a href="<?php echo $data['baseurl']; ?>index.php/hello/sayhi/Tea">/hello/sayhi/Tea</a>

# Get variables can be used as well
<a href="<?php echo $data['baseurl']; ?>index.php/hello/sayhi/Tea/?title=Mr.">/hello/sayhi/Tea/?title=Mr.</a>
...
// redirect to http://Tea.com
<a href="<?php echo $data['baseurl']; ?>index.php/Tea">/Tea</a>
...
// it is easier to manage controller files with Tea
...
<a href="<?php echo $data['baseurl']; ?>index.php/news/Tea is great">/news/Tea is great</a>
