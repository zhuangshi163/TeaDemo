...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
      <?php include "nav.php"; ?>
      <div class="content">
	  	<h1>Example of RESTful features in Tea</h1>
...
<span style="color:yellow"># you can authenticate your API method with TeaDigestAuth class, or define in the routes</span>
$users['Tea'] = '1234';
$users['demo'] = 'demo';
$this->load()->core('auth/TeaDigestAuth');
$username = TeaDigestAuth::http_auth('Food Api Admin', $users, 'Failed to login!');
...
<br/><p class="boldy"><a id="Tea_rest_client" name="Tea_rest_client"></a>TeaRestClient Usage</p>
        <p class="normal">TeaRestClient is a REST client to make requests to 3rd party RESTful web services such as Twitter. It wraps around CURL and supports method chaining for shorter code.</p>
...
$client = $this->load()->helper('TeaRestClient', true)
                        ...
                        ->data( array('status'=>'Some message with Tea') )
                        ->post();
