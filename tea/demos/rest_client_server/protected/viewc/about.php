...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
	  ...
	  <div class="content">
		...
		<p class="normal">Here you can learn about how to make REST server/client with Tea.</p>
        ...
        <p class="normal">Download the <a class="file" href="http://Tea.com/download">source</a>.</p>
...
# This link get the followers of <a href="http://twitter.com/Tea">Tea</a> from Twitter
...
<a href="<?php echo $data['baseurl']; ?>index.php/client/twitter/post/:username/:password/:message">/client/twitter/post/:username/:password/:message</a>
		...
		<p class="boldy"><a name="extension_name" id="extension_name"></a>Test drive REST APIs built with Tea:</p>
        <pre>
