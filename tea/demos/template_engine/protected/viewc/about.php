...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
	  ...
	  <div class="content">
		...
		<p class="normal">Here you can learn about how to do the view part in MVC with Tea using its template engine.</p>
...
<hr/>
	...
	<?php if (!Tea::cache('front')->getPart('messages', 3600)): ?>
<?php Tea::cache('front')->start('messages'); ?>
