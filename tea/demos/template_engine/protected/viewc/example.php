...
<span style="color:yellow"># Using assoc array, $data['user']['fullname'] = 'Tea'</span>
...
<pre>
<span style="color:yellow"># Looping a simple array $data['users']=array('john','Tea','marie') </span>
&lt;!-- loop users --&gt;
