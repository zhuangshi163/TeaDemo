...
class MainController extends TeaController{
    ...
    public function index(){
        ...
        $data['nested'] = 'Hello! Tea';

        $data['username'] = 'Teademo';
        $data['pwd'] = '1234';
		...
		if(Tea::cache('front')->testPart('messages', 3600)==false){
        ...
        $data['msgdetails'] = array(
                                array('subject'=>'Cool stuff on my Tearmat', 'date'=>'2009-09-13', 'attachment'=>array('pdf'=>'benchmark.pdf', 'doc'=>'readme.doc')),
        ...
        /*  This is useful in production mode where Tea doesn't auto process it for performance.
    ...
    public function template_source(){
        print_r(file_get_contents( Tea::conf()->SITE_PATH .'protected/view/about.html' ));
        exit;
    }
