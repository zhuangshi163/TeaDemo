        <h2>Tags :</h2>
        <?php if (!Tea::cache('front')->getPart('sidebarTag', 300)): ?>
<?php Tea::cache('front')->start('sidebarTag'); ?>
...
<?php endif; ?>
        ...
        <h2>Archives</h2>
        <ul>
          <?php if (!Tea::cache('front')->getPart('sidebarArchive', 31536000)): ?>
<?php Tea::cache('front')->start('sidebarArchive'); ?>
