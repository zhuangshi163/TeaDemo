...
$dbconfig['dev'] = array('localhost', 'TeaDemo', 'root', '', 'mysql', true, 'collate'=>'utf8_unicode_ci', 'charset'=>'utf8');
$dbconfig['prod'] = array('localhost', 'TeaDemo', 'root', '', 'mysql', true, 'collate'=>'utf8_unicode_ci', 'charset'=>'utf8');
