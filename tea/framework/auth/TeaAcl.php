 ...
 *
 * <p>TeaAcl performs authorization checks for the specified resource and action. It checks against the rules defined in acl.conf.php.</p>
 ...
 * </code>
 *
 * <p>You have to assign the rules to TeaAcl in bootstrap.</p>
 * <code>
 * # set rules
 * Tea::acl()->rules = $acl;
 *
 ...
 *
 * @author Leng Sheng Hong <darkredz@gmail.com>
 * @version $Id: TeaAcl.php 1000 2009-08-23 20:46:49
 * @package Tea.auth
 * @since 1.1
 */
class TeaAcl {
	 ...
	 * Tea::acl()->isAllowed('member', 'BlogController', 'post' );
	 *
	 * //Check if member is allowed for BlogController
	 * Tea::acl()->isAllowed('member', 'BlogController');
	 * </code>
	 *
	 * @param string $role Role of a user, usually retrieve from user's login session
	 * @param string $resource Resource name (use Controller class name)
	 ...
	 * Tea::acl()->isDenied('member', 'BlogController', 'post' );
	 *
	 * //Check if member is denied from BlogController
	 * Tea::acl()->isDenied('member', 'BlogController');
	 * </code>
	 *
	 * @param string $role Role of a user, usually retrieve from user's login session
	 * @param string $resource Resource name (use Controller class name)
