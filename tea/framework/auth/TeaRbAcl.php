...
*
*/
Tea::loadCore('auth/TeaAcl');

class TeaRbAcl extends TeaAcl{
     ...
     * Tea::acl()->isAllowed(array('member','admin'), 'BlogController', 'post' );
     *
     * //Check if members are allowed for BlogController
     * Tea::acl()->isAllowed(array('anonymous','member'), 'BlogController');
     * </code>
     *
     ...
     * Tea::acl()->isDenied(array('member','admin'), 'BlogController', 'post' );
     *
     * //Check if members are denied from BlogController
     * Tea::acl()->isDenied(array('anonymous','member'), 'BlogController');
     * </code>
     *
