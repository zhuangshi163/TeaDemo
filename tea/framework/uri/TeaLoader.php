...
class TeaLoader {
    ...
    /**
     * short hand of Tea::loadCore()
     * @param string $class_name
     */
    public function core($class_name){
        Tea::loadCore($class_name);
    }

    /**
     * short hand of Tea::autoload()
     * @param string $class_name
     */
    public function autoload($class_name){
        Tea::autoload($class_name);
    }

    /**
     * short hand of Tea::loadHelper()
     * @param string $class_name
    ...
    public function helper($class_name, $createObj=false){
        return Tea::loadHelper($class_name, $createObj);
    }

    /**
     * short hand of Tea::loadClass()
     * @param string $class_name
     * @param bool $createObj
     * @return mixed If $createObj is True, it returns the created Object
     */
    public function classes($class_name, $createObj=false){
        return Tea::loadClass($class_name, $createObj);
    }

    /**
     * short hand of Tea::loadController()
     * @param string $class_name
     */
    public function controller($class_name){
        Tea::loadController($class_name);
    }

    /**
     * short hand of Tea::loadModel()
     * @param string $class_name
     * @param bool $createObj
     * @return mixed If $createObj is True, it returns the created Object
     */
    public function model($class_name, $createObj=false){
        return Tea::loadModel($class_name, $createObj);
    }
