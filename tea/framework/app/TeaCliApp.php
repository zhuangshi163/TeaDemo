...
/**
 * TeaCliApp for CLI application usage
 * @author Richard Myers <richard.myers@hotmail.co.uk>
 * @package Tea.app
 * @since 1.4 
 */
class TeaCliApp {
	...
	private function runController($controller, $action, $arguments) {
		$controllerFile = Tea::conf()->SITE_PATH . Tea::conf()->PROTECTED_FOLDER . "controller/{$controller}.php";

		if (file_exists($controllerFile)) {
			require_once Tea::conf()->BASE_PATH ."controller/TeaCliController.php";
