...
/**
 * TeaFileCache provides file based caching methods.
 *
 * @author Leng Sheng Hong <darkredz@gmail.com>
 * @version $Id: TeaFileCache.php 1000 2009-08-27 19:36:10
 * @package Tea.cache
 * @since 1.1
 */
    ...
    public function __construct($path='') {
        if ( $path=='' ) {
            if(isset(Tea::conf()->CACHE_PATH))
                $this->_directory = Tea::conf()->CACHE_PATH;
            else
                $this->_directory = Tea::conf()->SITE_PATH . Tea::conf()->PROTECTED_FOLDER . 'cache/';
        }else{
