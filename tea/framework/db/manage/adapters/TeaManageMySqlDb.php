...
class TeaManageMySqlDb extends TeaManageDb {
	...
	protected $colTypeMapping = array (
    	...
    	TeaManageDb::COL_TYPE_DECIMAL	=> 'DECIMAL',
    	TeaManageDb::COL_TYPE_FLOAT		=> 'DOUBLE',
    	TeaManageDb::COL_TYPE_CHAR		=> 'CHAR',
    	TeaManageDb::COL_TYPE_VARCHAR	=> 'VARCHAR',
    	TeaManageDb::COL_TYPE_CLOB		=> 'LONGTEXT',
    	TeaManageDb::COL_TYPE_DATE		=> 'DATE',
    	TeaManageDb::COL_TYPE_TIME		=> 'TIME',
    	TeaManageDb::COL_TYPE_TIMESTAMP	=> 'DATETIME',
	);
