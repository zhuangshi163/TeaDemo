...
/**
 * TeaMasterSlave is an ORM tool based on TeaSqlMagic with Database Replication support.
 *
 ...
 *
 * <p>TeaMasterSlave <b>DOES NOT</b> send SELECT statement to a random slave. Instead, it is based on calculation with both access time and Slave nodes.</p>
 *
 ...
 *
 * @author Leng Sheng Hong <darkredz@gmail.com>
 * @version $Id: TeaMasterSlave.php 1000 2009-08-20 22:53:26
 * @package Tea.db
 * @since 1.1
 */

Tea::loadCore('db/TeaSqlMagic');

class TeaMasterSlave extends TeaSqlMagic {
