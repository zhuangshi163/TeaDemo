...
/**
* TeaBenchmark class, for benchmarking memory and time of particular code segment
*
* @author Zohaib Sibt-e-Hassan <zohaib.hassan@gmail.com>
...
class TeaBenchmark {
    ...
    * This subroutine will look up for any benchmarks that were marked with TeaBenchmark::mark
    * And for all unsaved 
    * 
