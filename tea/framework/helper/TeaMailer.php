...
/**
 * TeaMailer class, for sending e-mails
 *
 * @author Milos Kovacki <kovacki@gmail.com>
...
class TeaMailer {
	...
	public function send() {
		...
		$boundryMixed = 'Tea-mixed-' . $random_hash;		// Boundry for mixed content type (ie. Text and File Attachments)
		$boundryAlt   = 'Tea-alt-' . $random_hash;		// Boundry for Alternative mail types (ie. plain and html)
