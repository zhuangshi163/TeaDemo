 ...
 *
 * @author Leng Sheng Hong <darkredz@gmail.com>
 * @version $Id: TeaTextHelper.php 1000 2009-08-4 11:17:22
 * @package Tea.helper
 * @since 1.1
 */
class TeaTextHelper {
     ...
     * @param string $emailHide Change this if you want to hide the email. eg. leng[AT]Tea.com, value = '[AT]'
     * @return string
     */
