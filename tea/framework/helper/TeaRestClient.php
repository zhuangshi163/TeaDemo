 ...
 *
 * <p>You can send GET, POST, PUT and DELETE requests with TeaRestClient.
 * Method chaining is also supported by this class.</p>
 * Example usage:
 * <code>
 * //Example usage in a Tea Controller
 ...
 * </code>
 * @author Leng Sheng Hong <darkredz@gmail.com>
 * @version $Id: TeaRestClient.php 1000 2009-07-7 18:27:22
 * @package Tea.helper
 * @since 1.0
 */
class TeaRestClient {
    ...
    //for sending Accept header, this is to be used with requests to REST server which is built with Tea Framework
     ...
     * <code>
     * $client = new TeaRestClient('http://somewebsite.com/api/rest');
     ...
     *
     * <p>If you are implementing your own RESTful api, you can handle authentication with TeaDigestAuth::http_auth()
     ...
     * TeaRestClient provides a list of common used format to be used in your code.</p>
     ...
     *        ->auth('username', 'password', true)
     *        ->setContentType(TeaRestClient::JSON)
     *        ->post();
     * </code>
     * @param string $type
     * @return mixed
