...
* <code>
* $flash = new TeaFlashMessenger();
* TeaController::view()->flashMessenger = $flash;
* </code>
*
* <p>Now in your template file just do:</p>
* <code>$this->flashMessenger->displayMessages();</code>
*/
class TeaFlashMessenger {

	/**
	* Namespace for session, default is TeaFlashMessenger
	* @var string namespace
	*/
	protected $_namespace = 'TeaFlashMessenger';
	...
	*/
	...
	/**
	* Set namespace, default is Tea
	* @param string $namespace Namespace
	*/
	public function setNamespace($namespace = 'Tea') {
